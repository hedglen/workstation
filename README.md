...
├── wezterm/
│   ├── wezterm.lua                ← gui-startup tabs: system, wsl, grok, claude, codex, vibe, git, toolbelt
...
│   ├── setup.sh                   ← idempotent WSL provisioning (apt, zsh/omz/p10k, uv, claude/codex/grok/vibe)
...
| **Terminal / shell** | Windows Terminal, WezTerm, Oh My Posh (winget); trials: Rio, Alacritty, winghostty, Warp, Wave |
